...
class TilesTest {
    ...
    fun `Tiles - 중복 타일 생성에 대한 예외처리 테스트`() {
        // given
        val coordinate = Coordinate(Position(0), Position(0))
    ...
    fun `Tiles - 문자열 타일 목록 반환 테스트`() {
        // given
        val tile1 = NotChecked(Coordinate(Position(0), Position(0)), false)
        val tile2 = Mine(Coordinate(Position(0), Position(1)))
        val tile3 = NotChecked(Coordinate(Position(0), Position(2)), false)
