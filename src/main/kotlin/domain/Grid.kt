...
class Grid(
    ...
    private fun countAdjacentMines(
        ...
        return directions.count { (dr, dc) ->
            val newRow = row + dr
            val newCol = col + dc
            newRow in 0 until rowCount &&
                newCol in 0 until columnCount &&
                getCellAt(newRow, newCol) is Cell.MineCell
        }
    }
}
