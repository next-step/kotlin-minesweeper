...
class MineLocationValidator {
    ...
    fun validateMineLocation(board: List<List<Char>>, mineLocation: MineLocation): Boolean {
        isLocationInIndexOfBoard(board, mineLocation)
        return isDuplicatedMineLocation(board, mineLocation)
    }

    private fun isLocationInIndexOfBoard(board: List<List<Char>>, mineLocation: MineLocation) {
    ...
    private fun isDuplicatedMineLocation(board: List<List<Char>>, mineLocation: MineLocation): Boolean {
        val (x, y) = mineLocation.location
        return board[y][x] == '*'
    }
